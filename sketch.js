...
function preload(){
  jedin = loadImage("jedi ship/jedi ship n.png");
  jedis = loadImage("jedi ship/jedi ship s.png");
  jedie = loadImage("jedi ship/jedi ship e.png");
  jediw = loadImage("jedi ship/jedi ship w.png");
  jedine = loadImage("jedi ship/jedi ship ne.png");
  jedinw = loadImage("jedi ship/jedi ship nw.png");
  jedise = loadImage("jedi ship/jedi ship se.png");
  jedisw = loadImage("jedi ship/jedi ship sw.png");
  lowstdn = loadImage("lowstd/lowstdship n.png");
  lowstds = loadImage("lowstd/lowstdship s.png");
  lowstde = loadImage("lowstd/lowstdship e.png");
  lowstdw = loadImage("lowstd/lowstdship w.png");
  lowstdne = loadImage("lowstd/lowstdship ne.png");
  lowstdnw = loadImage("lowstd/lowstdship nw.png");
  lowstdse = loadImage("lowstd/lowstdship se.png");
  lowstdsw = loadImage("lowstd/lowstdship sw.png");
